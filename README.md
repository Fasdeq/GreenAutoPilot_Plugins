...
1. **Найдите файл** для вашей видеокарты в списке файлов (например, `rtx_3060_msi_ventus.json` или просто `rtx3060_rtx3070.json`).
2. **Скачайте его** (Raw -> Save As).
3. **Переименуйте** файл так, чтобы он соответствовал тому, как вашу карту видит драйвер (обычно достаточно упростить до `rtx3060_rtx3070.json`).
